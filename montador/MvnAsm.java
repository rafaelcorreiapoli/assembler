...
public class MvnAsm {
    ...
    public static void main(String[] args) {
        ...
        symbolTable.insertSymbol("X");

        System.out.println(symbolTable.symbolInTable("X")); // true
        System.out.println(symbolTable.symbolInTable("Z")); // false
        System.out.println(symbolTable.definedSymbol("X")); // false
        System.out.println(symbolTable.definedSymbol("Z")); // false
        symbolTable.setSymbolValue("X", "0001");
        System.out.println(symbolTable.definedSymbol("X")); // true
        System.out.println(symbolTable.getSymbolValue("Z")); // null
        System.out.println(symbolTable.getSymbolValue("X")); // 0001

        Pass1 pass1 = new Pass1();
        System.out.println(pass1.defineNewOrigin("/00FA"));
